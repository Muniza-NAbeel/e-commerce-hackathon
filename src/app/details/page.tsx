...
export default function page() {
  return (
    <div className="w-full flex">
      ...
      <div className="sec w-full sm:w-[75%] bg-[#f6f7f9] p-4 sm:p-6  flex flex-col gap-10 font-plus-jakarta-sans">
        <section className=" w-full flex flex-col md:flex-row gap-5  items-center justify-around">
          ...
          <div className="flex flex-col w-full  lg:max-w-[492px] h-auto lg:max-h-[508px] bg-white justify-between rounded-xl shadow-md">
            ...
            <div className="p-4 flex  items-center gap-4">
              ...
              <Link href={"/payment"}>
                <button className="bg-[#3563e9] hover:bg-[#54A6FF] active:bg-[#3563e9] active:scale-95 transition-all shadow-md p-3 sm:p-4 px-6 sm:px-10 text-nowrap text-white rounded-md w-full max-w-[180px] text-center">
                  Rent Now
                </button>
              </Link>
            </div>
        ...
        <section className="popular w-full flex flex-col gap-5">
          <div className="first w-full flex items-center justify-between px-10 xl:px-14">
            ...
            <Link href={"/categories"}>
              <h1 className="text-[#3563E9] font-semibold text-[16px] leading-[24px] tracking-[-2%] hover:underline decoration-[#3563e9]">
                View All
              </h1>
            </Link>
          </div>
