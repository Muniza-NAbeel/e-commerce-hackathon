      ...
      <div className="sec w-full sm:w-[80%] bg-[#f6f7f9] p-4 sm:p-6  flex flex-col gap-10 font-[family-name:var(--font-geist-sans)]">
        <section className="w-full flex flex-col sm:flex-row items-center justify-center sm:justify-between">
          <Image
            ...
            width={582}
            height={132}
            className="sm:w-[180px] md:w-[220px] lg:w-[500px]"
          />
          <Image
            src={"/Switch.png"}
            alt=""
          ...
          <Image
            ...
            width={582}
            height={132}
            className="sm:w-[180px] md:w-[220px] lg:w-[500px]" // Reduced width
          />
        </section>
        ...
        <section className="button w-full text-center">
          <button
            ...
            className="bg-[#3563e9] px-4 py-2 text-white rounded-md mt-5 hover:bg-[#54A6FF] active:bg-[#3563e9] active:scale-95 transition-all shadow-md"
          >
